...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/adam/capstone/username')
    password_param = ssm.get_parameter(Name="/adam/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.cszfgz7hcyld.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'adamcapstonestatic' # please enter your s3 bucket name
